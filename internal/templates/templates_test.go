...
func TestParseKV(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: map[string]string{"keyword1": "value1", "keyword2": "value2", "keyword3": "value3,value4,value5", "keyword4": "value6"},
		},
		{
			name: "TestParseKV 2",
			args: args{
			...
			want: map[string]string{"keyword1": "value1", "keyword2": "value2", "keyword3": "value3,value4,value5:value6,value7,value8", "keyword4": "value9"},
		},
	}
