...
${PROBE_DISABLED/#true/#}    .url = "${PROBE_URL}";
${PROBE_DISABLED/#true/#}    .timeout = 2s;
${PROBE_DISABLED/#true/#}    .interval = 5s;
${PROBE_DISABLED/#true/#}    .window = 10;
${PROBE_DISABLED/#true/#}    .threshold = 5;
${PROBE_DISABLED/#true/#}}
...
sub vcl_recv {
  set req.backend_hint = ddir.backend("${BACKEND_HOST}");
    if (req.method == "PURGE") {
        if (client.ip !~ purge) {
